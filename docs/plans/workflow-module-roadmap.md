---
title: ScribeFlow 功能工作流模块拓展路线图（R5 定稿）
class: plan
status: accepted
owner: 念前
...
> 状态：**P0（M6）已实施完毕；M7/M8 未开工**（路线图本身仍然有效，后续按里程碑立实施文档）
> 输入：R1 桌面研究报告 [r1-desktop-research.md](../research/r1-desktop-research.md)、方案文档 [scribe-flow-proposal.md](../decisions/scribe-flow-proposal.md)
...
| 里程碑 | 内容 | 体量估计 |
|---|---|---|
| **M6 基础件补全** | 重试策略、条件分支、文本工具、章节切分（**已落地**，决策见 [early-decisions.md](../decisions/early-decisions.md)） | 约 2 周 |
