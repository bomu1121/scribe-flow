---
title: UI 样式框架选型与组件实现调研（代码级，历史，已被 Element Plus 路线取代）
class: decision
status: superseded
owner: 念前
last_reviewed: 2026-08-28
superseded_by: docs/decisions/ui-library-replacement-research.md
---

# UI 样式框架选型与组件实现调研（代码级，历史，已被 Element Plus 路线取代）

> ⚠️ **历史文档（2026-08-28 起不再执行）**：本方案（shadcn-vue 复制件）已被用户否决。当前通用 UI 底座为 **Element Plus**，详见 [ui-library-replacement-research.md](./ui-library-replacement-research.md)。本文仅保留作决策过程归档。
>
